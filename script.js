...
// afficher le message (valeurs initiales ci-dessus)
renderFamilyMessage(FAMILY_MESSAGE);

// ----- Petite note pour développeur débutant -----
// Pour remplacer le texte ou la source du message : modifier la constante FAMILY_MESSAGE plus haut.
// Pour remplacer les images : déposer des fichiers dans le dossier images/ et
// modifier la constante IMAGES pour changer la légende, l'auteur, ou la durée.
